...
const blogData: Blog[] = [
  
  {
    ...
    paragraph:
      "Learn building finely tuned strategies, crafted through a decade of backtesting historical data, and learn the most effective parameters from our financial trainers.",
  ...
  },
  {
    ...
    paragraph:
      "Our in-depth equity research services offer valuable insights and analysis of individual stocks, helping you make informed investment decisions in the equity market. ",
