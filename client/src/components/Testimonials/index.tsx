...
const Testimonials = () => {
  return (
    <section className="dark:bg-bg-color-dark relative z-10 py-16 md:py-20 lg:py-28" style={{backgroundColor:'#3EB449'}}>
      <div className="container">
        <SectionTitle
          title="What Our Users Says"
          paragraph="Our users rave about our expert guidance, valuable resources, and transformative financial empowerment."
          center
        />
