...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-lg bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11 h-full">
      <h3 className="mb-4 text-2xl leading-tight font-medium text-black dark:text-white">
        Subscribe to receive future updates
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed dark:border-white dark:border-opacity-25">
      Stay informed on financial insights and upcoming events. Subscribe now for exclusive updates and content
      </p>
      <div>
        <input
          type="text"
          ...
          className="border-stroke mb-10 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none"
        />
        <input
          type="email"
          name="email"
