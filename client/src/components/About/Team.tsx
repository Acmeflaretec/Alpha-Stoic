  ...
  return (
    <section id="team" className="py-16 md:py-20 lg:py-28">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {teamMembers.map((member) => (
            <div key={member.id} className="flex flex-col items-center bg-gray-light dark:bg-bg-color-dark p-4 rounded-lg">
              <div className="relative">
                <img
                  src={member.image}
                  alt={member.name}
                  className="w-32 h-32 rounded-full grayscale object-cover mb-4"
